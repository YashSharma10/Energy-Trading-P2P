      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 gap-12 xl:grid-cols-4 lg:gap-8">
          ...
          <div className="flex flex-col gap-6 xl:col-span-2">
            <Link to="/" className="inline-block flex-shrink-0 transition-transform hover:scale-[1.02]">
              <Logo className="h-10 w-auto object-contain" />
            </Link>
            <p className="max-w-md text-[15px] text-muted-foreground leading-relaxed">
              CarbonEase makes trading voluntary carbon credits transparent, simple, and direct. Join us in funding verified renewable energy projects to drive the transition to a net-zero future.
            </p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <ul className="space-y-4">
              <li className="flex group items-start gap-3 text-muted-foreground transition-colors hover:text-foreground">
                ...
                <a href="mailto:support@carbonease.com" className="text-[15px]">support@carbonease.com</a>
              </li>
              <li className="flex group items-start gap-3 text-muted-foreground transition-colors hover:text-foreground">
        ...
        <div className="mt-16 flex flex-col items-center justify-between border-t border-border/50 pt-8 pb-4 sm:flex-row gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} CarbonEase. All rights reserved.
          </p>
